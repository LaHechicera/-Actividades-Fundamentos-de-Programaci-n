...
print("Puedes moverte a la derecha con 'd', a la izquierda con 'a' o hacia delante con 'w'")
print(" ")
print("Inicia la aventura!")
opcion = input("Corres hacia la montaña nevada. Un ruido te detiene. (muevete hacia algun lado): ").lower()
if opcion == "a":
    ...
    opcion = input("Te quedan muy quieto. Después de un momento te comienzas a deslizar hacia un lado. ")
    if opcion == "w":
        print("Te mueves un poco hacia adelante y el túnel te lleva al 9 siguiente nivel")
    elif opcion == "a":
        print("Te mueves hacia la izquierda y una planta carnívora de come.")
    else:
